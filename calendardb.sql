...
COPY Person (ID, Person_Name, Person_Password) FROM stdin;
1 Lucas example1
2 Omar example2
3 Veronika example3
4 Safwaan example4
...
COPY PersonAvailableDays (ID, Person_AvailableDay, Person_ID) FROM stdin;
1	2022-02-21 1
2	2022-02-22 1
3	2022-02-23 1
4	2022-02-24 1
...
COPY CalendarGroup (Group_Code, Group_Name, Creator_Name, Group_Start, Group_End, GroupMembers) FROM stdin;
1	Group 1 Meeting	Veronika 2022-02-21 2022-03-02	4
2	Group 2 Meeting	Neil 2008-11-12 2022-02-26	1
\.

COPY Color(Number_People, Hex_Value, Color_Name) FROM stdin;
1	#FFFF00 Yellow
2	#9acd32 YellowGreen
3	#00FF00 Green
\.

COPY GroupMembers (Group_Code, PersonID) FROM stdin;
1	1
1	2
1	3
1	4
...
COPY AvailableDaysJoin (Group_Avail_ID, Person_Avail_ID) FROM stdin;
1	1
1	2
1	3
1	4
...
COPY GroupAvailableDays (ID, Group_Code, Available_Day, Num_People) FROM stdin;
1	1	2022-02-21 4
2	1	2022-02-22 3
3	1	2022-02-23 2
4	1	2022-02-24 1
